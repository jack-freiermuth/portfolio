...
<head>
	...
	<meta name="description"
		  content="Create your personal portfolio website with this HTML5 well coded onepage responsive theme.">
	<meta name="keywords"
		  content="HTML5, onepage theme, responsive, onepage html5 template, personal portfolio template">
...
<header><!--Header-->
	...
	<nav class="navbar navbar-default navbar-sticy-top"><!--Logo & menu-->
		<div class="container">
...
<section id="home" class="homearea"><!--home-->
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-md-12">
				<div class="home-in">
					<img src="images/Sqaure.jpg" alt="">
